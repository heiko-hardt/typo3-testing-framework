...
/**************************************************************************************************
 * This class is a copy from the TYPO3 v.6.2.31 source code
 * FQCN: \TYPO3\CMS\Core\Tests\FunctionalTestCaseBootstrapUtility
 *
 * There are no changes within the code.
 * Only namespace and classname changed.
 *************************************************************************************************/
...
namespace HeikoHardt\TYPO3TestingFramework\Resources;

/**
 * Utility class to set up and bootstrap TYPO3 CMS for functional tests
 */
class TestCaseBootstrapUtilityV62 {
